...
var preloaderCircle = new  configComponent({
	...
	methods : {
		setStyle : function(){
			var out;
			out = {borderColor : this.colorHexa}	
			return out;
		},
	}
});
...
var hr = new configComponent({
	...
	template : 
	'<transition name="fade">\
	<hr key="this.generateId(5)" v-show="this.show" v-bind:size="this.size" v-bind:width="this.width" v-bind:style="this.style" v-bind:id="this.generateId(5)">\
	</transition>',
	methods : {
		setStyleP : function(arg){
			this.styleP = arg;
...
var form = new configComponent({
	...
	template : 
	'<transition name="fade">\
	<form v-bind:action="this.actionUrl" key="this.generateId(5)" v-show="this.show" v-bind:method="this.generateMethod()" v-bind:enctype="this.generateEnctype()" v-bind:id="this.generateId(5)" v-bind:class="this.setClass()"><slot></slot></form>\
	</transition>',
	methods : {
		generateTag : function(){
			var tagName = "form";
...
var button =  new configComponent({
	...
	template : 
	'<transition name="fade">\
	<div v-bind:is="this.generateTag()" key="this.generateId(5)" v-show="this.show" v-bind:type="this.generateType()" v-bind:id="this.generateId(5)" v-bind:style="this.generateStyle()" v-bind:class="this.setClass()">{{this.text}}</div>\
	</transition>',
	methods : {
		generateStyle : function(){
			var style = {};
...
var inputFields = new configComponent({
	...
	methods : {
		...
		generateType : function(){
			var type = new Array("text", "email", "password", "hidden");
			return type[this.type];	
		},
	}
});
...
var preloaderCircleFull = new configComponent({
	...
	methods : {
		setColorHexa : function(arg){
			...
			if(this.$el){
				container = this.getChild(this);
				preloaderCircle = this.getChild(container).setColor(arg);
			}
			return this;
		},
		setSectionColor : function(arg){
	...
	render : function (createElement) {
		...
		console.log(preloaderCircle.setStyle());
		csection.create(ccontainer);
